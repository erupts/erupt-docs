                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        {text: 'LLM Setup', link: '/en/modules/erupt-ai/llm'},
                                        {text: 'AI Chat', link: '/en/modules/erupt-ai/chat'},
                                        {text: 'Experts', link: '/en/modules/erupt-ai/agent'},
                                        {text: 'Tools & Role Authorization', link: '/en/modules/erupt-ai/tools'},
                                        {text: 'Connecting MCP Servers', link: '/en/modules/erupt-ai/mcp'},
                                        {text: 'Built-in MCP Server', link: '/en/modules/erupt-ai/mcp-server'},
                                        {text: 'Prompt Engineering', link: '/en/modules/erupt-ai/prompt'},
                                        {text: 'Multi-Agent Collaboration (A2A)', link: '/en/modules/erupt-ai/a2a'},
                                        {text: 'Cross-Session Memory', link: '/en/modules/erupt-ai/memory'},
                                        {text: 'AI Writing Assistant', link: '/en/modules/erupt-ai/writing-assistant'},
                                    ],
                                },
                                {
                                    text: '🦞 Erupt AI Claw',
                                    ...
                                    items: [
                                        ...
                                        {text: 'Claw and Skills', link: '/en/modules/erupt-ai-claw/skill'},
                                        {text: 'Erupt Model Interaction', link: '/en/modules/erupt-ai-claw/erupt-model'},
                                        {text: 'Operating System Interaction', link: '/en/modules/erupt-ai-claw/os'},
                                        {text: 'Browser Interaction', link: '/en/modules/erupt-ai-claw/browser'},
                                        {text: 'Long-Term Memory', link: '/en/modules/erupt-ai-claw/memory'},
                                        {text: 'Spring Boot', link: '/en/modules/erupt-ai-claw/spring-boot'},
                                        {text: 'Tool Reference & Authorization', link: '/en/modules/erupt-ai-claw/tools'},
                                    ],
                                },
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        {text: 'LLM 接入', link: '/zh/modules/erupt-ai/llm'},
                                        {text: 'AI 对话', link: '/zh/modules/erupt-ai/chat'},
                                        {text: '专家', link: '/zh/modules/erupt-ai/agent'},
                                        {text: '工具与角色授权', link: '/zh/modules/erupt-ai/tools'},
                                        {text: '接入 MCP 生态', link: '/zh/modules/erupt-ai/mcp'},
                                        {text: '内置 MCP Server', link: '/zh/modules/erupt-ai/mcp-server'},
                                        {text: '提示词工程', link: '/zh/modules/erupt-ai/prompt'},
                                        {text: '多 Agent 协作（A2A）', link: '/zh/modules/erupt-ai/a2a'},
                                        {text: '跨会话记忆', link: '/zh/modules/erupt-ai/memory'},
                                        {text: 'AI 写作助手', link: '/zh/modules/erupt-ai/writing-assistant'},
                                    ],
                                },
                                {
                                    text: '🦞 Erupt Ai Claw',
                                    ...
                                    items: [
                                        ...
                                        {text: '与 Skill', link: '/zh/modules/erupt-ai-claw/skill'},
                                        {text: '与 Erupt 模型交互', link: '/zh/modules/erupt-ai-claw/erupt-model'},
                                        {text: '与操作系统交互', link: '/zh/modules/erupt-ai-claw/os'},
                                        {text: '与浏览器交互', link: '/zh/modules/erupt-ai-claw/browser'},
                                        {text: '与长期记忆', link: '/zh/modules/erupt-ai-claw/memory'},
                                        {text: '与 Spring Boot', link: '/zh/modules/erupt-ai-claw/spring-boot'},
