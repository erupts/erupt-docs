...
This page collects the changelogs and documentation links for the Erupt 1.x release line. For the current 2.x releases, see the [Changelog](/en/guide/changelog).

:::tip Release lines
1.x and 2.x are independent release lines: 1.14.x is the final 1.x series, and 2.0.0 moves to Hibernate 6 with breaking changes. Read the [Upgrade Guide](/en/guide/upgrade) before upgrading.
:::
...
For versions older than 1.14.x, please consult the [Chinese version](/zh/guide/history) — an English translation will be provided in a future iteration.
