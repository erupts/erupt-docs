...
| 模块             | 说明           | 文档                          |
|----------------|--------------|-----------------------------|
| `erupt-flow`   | 通用流程引擎       | [详情](/pro/erupt-flow)   |
| `erupt-tenant` | SaaS 多租户     | [详情](/pro/erupt-tenant) |、
| `erupt-chart`  | 低代码数据可视化     | [详情](/pro/erupt-chart)  |
| `erupt-cube`   | 语义建模 + 数据可视化 | [详情](/pro/erupt-cube)       |
