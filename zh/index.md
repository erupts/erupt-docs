...
| 模块 | 说明 |
| --- | --- |
| [erupt-upms](/zh/modules/erupt-upms) | 用户权限管理：用户、角色、菜单、组织、字典 |
| [erupt-job](/zh/modules/erupt-job) | 可视化定时任务管理，支持 Cron 表达式与任务日志 |
| [erupt-monitor](/zh/modules/erupt-monitor) | 服务监控：CPU / JVM / Redis / 在线用户 |
| [erupt-notice](/zh/modules/erupt-notice) | 站内通知、全员公告、可插拔多渠道推送 |
| [erupt-tpl](/zh/modules/erupt-tpl) | 自定义页面，支持 Freemarker / Amis / 微前端 |
| [erupt-magic-api](/zh/modules/erupt-magic-api) | 在线 IDE，浏览器编写接口代码实时生效 |
| [erupt-cloud](/zh/modules/erupt-cloud) | 分布式微服务配置管理，替代 Apollo / Nacos |

**AI 模块**

| 模块 | 说明 |
| --- | --- |
| [🐴 Erupt AI Harness](/zh/modules/erupt-ai) | 深度集成 LLM，内置 Chat / Agent / MCP Server |
| [🦞 Erupt AI Claw](/zh/modules/erupt-ai-claw) | 自然语言驱动服务器，操作数据、执行 Shell、扩展 Skill |

**商业模块**

| 模块 | 说明 |
| --- | --- |
| [Erupt Flow](/zh/modules/pro/erupt-flow) | 可视化流程引擎，钉钉风格审批配置 |
| [Erupt Tenant](/zh/modules/pro/erupt-tenant) | SaaS 多租户，表级数据隔离 |
| [Erupt Cube](/zh/modules/pro/erupt-cube) | 语义层 BI 平台，对标 Google Looker |
| [Erupt Chart](/zh/modules/pro/erupt-chart) | 纯 SQL 低代码报表图表 |
